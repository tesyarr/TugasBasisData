sepatu<div class="span9">
  <div class="content">
    <div class="module">
      <div class="module-head">
        <h2 align="center" >Form Edit</h2>
        <?php
          $ambil=$koneksi->query("SELECT * FROM sepatu WHERE kode_sepatu='$_GET[id]'");
        ...
        <form method="POST" class="form-horizontal row-fluid">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" id="basicinput"  class="span8" name="gambar"  value ="<?php echo $pecah['gambar']?>">
              </div>
            </div>
            <div class="control-group">
      ...
      <?php
        ...
        {
          $sql=$koneksi->query("UPDATE sepatu SET nama_sepatu='$_POST[nama_seepatu]', harga_jual='$_POST[harga_jual]',
        , id_jenissepatu='$_POST[id_jenissepatu]' ,gambar='$_POST[gambar]', deskripsi='$_POST[deskripsi]' where kode_sepatu='$_GET[id]'");
          if(isset($sql)===TRUE) {
