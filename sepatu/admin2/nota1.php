            ...
            <div class="navbar-inner">
                <div class="container">
                    <a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
                        <i class="icon-reorder shaded"></i></a><a class="brand" href="index1.php?page=index">Belsbee</a>
                ...
                <div class="row">
                    <div class="span3">
                        <div class="sidebar">
							...
							<ul class="widget widget-menu unstyled">
                                <li><a href="index1.php?page=sepatuu"><i class="menu-icon icon-table"></i>sepatu </a></li>
						...
						<div class="module">
							...
							<div class="module-body table">
								<table  class="dataTables_wrapper .table-bordered"  border="1%" cellpadding="1%" cellspacing="1&" width="100%">
									...
									<tbody>
										<?php $nomor=1;?>
										<?php $ambil=$koneksi->query(" SELECT * FROM penyuplaian_barang join sepatuu on penyuplaian_barang.kode_sepatu=sepatuu.kode_sepatu
										where penyuplaian_barang.kode_fakturbeli='$_GET[ids]' and penyuplaian_barang.kode_sepatu=sepatuu.kode_sepatu"); ?>
