            ...
            <div class="container">
                <div class="navbar-header">
                   ...
                   <div class="navbar-collapse collapse">
					<div class="menu" class="table table-bordered">
					<nav>
    ...
    <div class="table table-success">
		<div class="container">
			<div class="left-text hidden-xs">
				...
				<p>
				<h5>Username &nbsp; &nbsp; &nbsp; &nbsp;: <?php echo $sepatu[ID_pembeli]; ?><br> </br>
					Nama &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;: <?php echo $sepatu[nama_pembeli]; ?> <br> </br>
					Nomor telepon : <?php echo $sepatu[no_telepon]; ?>
				<br></p>
