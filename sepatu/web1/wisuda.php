...
<div class="container">
    <div class ="row">
  <?php $ambil=$koneksi->query("SELECT * FROM sepatu where id_jenissepatu='H10002'");?>
  <?php while($sepatu=$ambil->fetch_assoc()){?>
  <div class="col-md-4">
    <img src="http://localhost/sepatu/foto/<?php echo $sepatu['gambar'];?>" width="360" height="360" class="img-responsive">
...
<div class="container">
    <div class ="row">
  <?php $ambil=$koneksi->query("SELECT * FROM sepatu where id_jenissepatu='K10001'");?>
  <?php while($sepatu=$ambil->fetch_assoc()){?>
  <div class="col-md-4">
    <img src="http://localhost/sepatu/foto/<?php echo $sepatu['gambar'];?>" width="360" height="360" class="img-responsive">
        <h4><?php echo $sepatu['nama_sepatu'];?></h4>
...
<div class="container">
    <div class ="row">
  <?php $ambil=$koneksi->query("SELECT * FROM sepatu where id_jenissepatu='L10001'");?>
  <?php while($sepatu=$ambil->fetch_assoc()){?>
  <div class="col-md-4">
    <img src="http://localhost/sepatu/foto/<?php echo $sepatu['gambar'];?>" width="360" height="360" class="img-responsive">
        <h4><?php echo $sepatu['nama_sepatu'];?></h4>
