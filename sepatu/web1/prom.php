...
<section class="home_banner_area">
  ...
  <div class="container">
    <div class="banner_content text-center">
      <h3>Prom and Birthday Party<br /></h3>
...
<div class="container">
    <div class ="row">
  <?php $ambil=$koneksi->query("SELECT * FROM baju where id_jenisbaju='F10001'");?>
...
<div class="container">
    <div class ="row">
  <?php $ambil=$koneksi->query("SELECT * FROM baju where id_jenisbaju='H10003'");?>
  <?php while($baju=$ambil->fetch_assoc()){?>
  <div class="col-md-4">
    <img src="http://localhost/toko_baju/foto/<?php echo $baju['gambar'];?>" width="360" height="360" class="img-responsive">
        <h4><?php echo $baju['nama_baju'];?></h4>
...
<div class="container">
    <div class ="row">
  <?php $ambil=$koneksi->query("SELECT * FROM baju where id_jenisbaju='L10001'");?>
  <?php while($baju=$ambil->fetch_assoc()){?>
  <div class="col-md-4">
    <img src="http://localhost/toko_baju/foto/<?php echo $baju['gambar'];?>" width="360" height="360" class="img-responsive">
        <h4><?php echo $baju['nama_baju'];?></h4>
